<?php 
	...
	$obj_bd = new inmuebles; // instancia de la clase del objeto
...
<div class="col-sm-2 col-md-3 col-xs-3 content">
	<form action="" method="POST" id="formulario">
        ...
        <input type="text" onkeypress="return validar_caja(this.id,'texto','','Solo letra.',event,'','validar2')" name="<?php echo $cam1; ?>" value="<?php  if(isset($obj_row[$cam1])) echo $obj_row[$cam1];?>" class="form-control requerido" id="texto0" required>
