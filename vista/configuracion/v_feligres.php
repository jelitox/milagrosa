<?php 
	@session_start();
	include_once ('../modelo/configuracion/m_feligres.php'); // incluyo el modelo del maestro
	$obj_bd = new feligres; // instancia de la clase del objeto
	...
	$url_control =  "../control/configuracion/c_feligres.php"; // url del controlador
	$url_reporte = "../control/controlreporte/c_repfeligres.php"; // url del controlador del reporte
	// $sql = "";
...
<div class="col-sm-2 col-md-3 col-xs-3 content">
	<form action="" method="POST" id="formulario">
        ...
        <span id="validar1" style="width: 100px; display: none;"></span>
						...
						<div class="col-sm-2 col-md-5 col-xs-3">
							<div class="form-group ">
								...
								<input type="text" class="form-control sm-2 requerido" id="texto3" name="sex" > -->
        ...
        <input readonly="readonly" type="text" name="<?php echo $cam8; ?>" value="<?php if(isset($nac)) echo $nac;?>" class="calendario form-control requerido" id="texto9" required>
						...
						<div class="col-sm-2 col-md-5 col-xs-3">
							<div class="form-group ">
								...
								<label for="<?php echo $cam7; ?>"> Edad  :<strong><i class="text-help fa fa-question-circle" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Número del celular de la Persona."></i></strong></label>
        						<input type="text" onkeypress="return validar_caja(this.id,'num','','Solo numeros.',event,'','validar5')" maxlength="2"  name="<?php echo $cam7; ?>" value="<?php  if(isset($obj_row[$cam7])) echo $obj_row[$cam7];?>" class="form-control requerido" id="texto7" required>
        						<span id="validar5" style="width: 100px; display: none;"></span>
						...
						<div class="col-sm-2 col-md-5 col-xs-3">
							<div class="form-group ">
        						...
        						<input type="text" onkeypress="return validar_caja(this.id,'num','','Solo numeros.',event,'','validar5')" maxlength="2"  name="<?php echo $cam7; ?>" value="<?php  if(isset($obj_row[$cam7])) echo $obj_row[$cam7];?>" class="form-control" id="texto8" required>
        						<span id="validar5" style="width: 100px; display: none;"></span>
