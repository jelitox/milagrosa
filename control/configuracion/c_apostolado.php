<?php 
session_start();
	include_once '../../modelo/configuracion/m_apostolado.php'; // incluyo clase del objeto sacramento
	$obj_modelo = new Apostolado;
	$tabla = 'tgrupo'; //tabla de la bd
	$campoest = 'estatus'; // campo estatus de la tabla
	$idcampo = 'idgrupo'; // id de tabla en la bd (identificador unico o llave primaria)
	...
	switch ($_POST['op']) {
		...
		case 'Consultar':
			...
			$obj_row = $obj_modelo->row($obj_modelo->consulta_mod($tabla,'WHERE','idgrupo',$_POST['idreg']));
